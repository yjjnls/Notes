- [BitCoin](#bitcoin)
    ...
    - [2. 《精通比特币》相关要点整理](#2-%E7%B2%BE%E9%80%9A%E6%AF%94%E7%89%B9%E5%B8%81%E7%9B%B8%E5%85%B3%E8%A6%81%E7%82%B9%E6%95%B4%E7%90%86)
        ...
        - [2.3 钱包](#23-%E9%92%B1%E5%8C%85)
            - [2.3.1 钱包分类](#231-%E9%92%B1%E5%8C%85%E5%88%86%E7%B1%BB)
            - [2.3.2 助记词](#232-%E5%8A%A9%E8%AE%B0%E8%AF%8D)
            - [2.3.3 从种子中创造HD钱包](#233-%E4%BB%8E%E7%A7%8D%E5%AD%90%E4%B8%AD%E5%88%9B%E9%80%A0hd%E9%92%B1%E5%8C%85)
...
### 2.3 钱包
**钱包是私钥的容器**，可以分为非确定性（随机）钱包（随机生成私钥）和确定性（种子）钱包。

#### 2.3.1 钱包分类
1.  不确定性钱包只是随机生成的私钥集合，缺点是如果你生成很多私钥，你必须保存它们所有的副本。
2.  对于确定性钱包，在这里你可以用原先的私钥，通过单向哈希函数来生成每一个新的私钥，并将新生成的密钥按顺序连接。只要你可以重新创建这个序列，你只需要第一个私钥（称作种子、主私钥）来生成它们。
3.  分层确定性钱包（HD钱包），包含以树状结构衍生的密钥，使得父密钥可以衍生一系列子密钥，每个子密钥又可以衍生出一系列孙密钥，以此类推，无限衍生。
...
todo 交易脚本的执行，补充进去：http://blockgeek.org/t/topic/1535/2
